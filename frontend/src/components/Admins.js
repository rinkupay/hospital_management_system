...
export default function AdminDashboard() {
  ...
  const fetchTotalDoctors = async () => {
    try {
      ...
      const response = await fetch('https://hospital-management-system-h1lt.onrender.com/api/admin/total-doctors', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchTotalPatients = async () => {
    try {
      ...
      const response = await fetch('https://hospital-management-system-h1lt.onrender.com/api/admin/total-patients', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchDoctorOverview = async () => {
    try {
      ...
      const response = await fetch('https://hospital-management-system-h1lt.onrender.com/api/admin/doctor-overview', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchPatientOverview = async () => {
    try {
      ...
      const response = await fetch('https://hospital-management-system-h1lt.onrender.com/api/admin/patient-overview', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const renderAddDoctor = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const response = await fetch('https://hospital-management-system-h1lt.onrender.com/api/admin/add-doctor', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
  ...
  const renderAddAdmin = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const response = await fetch('https://hospital-management-system-h1lt.onrender.com/api/admin/add-admin', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
